      ...
      builder: (ctx, state) {
        ...
        return Padding(
            ...
            child: Column(
              ...
              children: [
                TextFieldCubit.get(ctx).message != null
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      await gifPicker();
                                      if (gifPicked != null) {
                                        TextFieldCubit.get(ctx).sendGifMessage(
                                            isGroupChat: widget.isGroupChat,
                                            senderUser: TextFieldCubit.get(ctx)
                                                .userModel!,
                                            recieverId: widget.isGroupChat
                                                ? widget.groupId!
                                                : widget.recieverId!,
                                            text: gifPicked!.url!,
                                            replyOn: TextFieldCubit.get(ctx)
                                                    .message ??
                                                '',
                                            replyOnMessageType:
                                                TextFieldCubit.get(context)
                                                    ...
                                                    MessageEnum.text,
                                            replyOnUserName:
                                                TextFieldCubit.get(ctx).isMe ==
                                                        true
                                                    ? cubit.userModel!.name!
                                                    : TextFieldCubit.get(ctx)
                                                                .isMe ==
                                                            false
                                                        ? widget.receiverName
                                                        : '');
                                ...
                                children: [
                                  InkWell(
                                    onTap: () async {
                                      await imagePicker();
                                      if (imagePicked != null) {
                                        TextFieldCubit.get(ctx).sendFileMessage(
                                            isGroupChat: widget.isGroupChat,
                                            senderUser: TextFieldCubit.get(ctx)
                                                .userModel!,
                            ...
                            child: RawMaterialButton(
                              ...
                              onPressed: () async {
                                if (messageController.text.trim().isNotEmpty) {
                                  await TextFieldCubit.get(ctx).sendTextMessage(
                                      isGroupChat: widget.isGroupChat,
                                      senderUser:
                                          TextFieldCubit.get(ctx).userModel!,
                                      recieverId: widget.isGroupChat
                                          ? widget.groupId!
                                          : widget.recieverId!,
                                      text: messageController.text.trim(),
                                      replyOn:
                                          TextFieldCubit.get(ctx).message ?? '',
                                      replyOnMessageType:
                                          TextFieldCubit.get(ctx).messageType ??
                                              MessageEnum.text,
                                      replyOnUserName:
                                          TextFieldCubit.get(ctx).isMe == true
                                              ? cubit.userModel!.name!
                                              : TextFieldCubit.get(ctx).isMe ==
                                                      false
                                                  ? widget.receiverName
                                                  : '');
                                  if (TextFieldCubit.get(ctx).message != null) {
                                    TextFieldCubit.get(ctx).cancelReply();
                                  }
                                  ...
                                  if (isRecording) {
                                    ...
                                    await TextFieldCubit.get(ctx)
                                        .sendFileMessage(
                                            isGroupChat: widget.isGroupChat,
                                            senderUser: ChatCubit.get(context)
                                                .userModel!,
                                            receiverId: widget.isGroupChat
                                                ? widget.groupId!
                                                : widget.recieverId!,
                                    ...
                                    if (TextFieldCubit.get(ctx).message !=
                                        null) {
                                      TextFieldCubit.get(ctx).cancelReply();
                                    }
                                    setState(() {
